...
RUN wget  http://localhost:8082/artifactory/libs-release-local/com/nagarro/ourfirstapp/our-web-app/0.0.1-SNAPSHOT/our-web-app-0.0.1-20210331.154007-11.war /usr/local/tomcat/webapps
